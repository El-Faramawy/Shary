...
@section('page_title') أقسام التواصل @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">أقسام التواصل</h3>
                    ...
                    <div class="{{--table-responsive--}}">
                        <table id="exportexample" class="table table-striped table-responsive-lg  card-table table-vcenter text-nowrap mb-0 table-primary align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-white">المحتوى</th>
...
@push('admin_js')
    ...
    @include('layouts.admin.inc.ajax',['url'=>'contact_categories'])

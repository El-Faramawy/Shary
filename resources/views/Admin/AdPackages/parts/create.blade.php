...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('ad_packages.store')}}">
    @csrf
    <div class="row mt-0">
        <!--begin::Input group-->
        ...
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            ...
            <div class="d-flex align-items-center mb-3">
                <div class="form-check m-0 ">
                    <input class="form-check-input  " type="radio" name="type" value="ad" checked>
                    <label class="form-check-label ms-5" style="margin-right: 20px;">
                        اعلان
                    </label>
                </div>
                <div class="form-check m-0  ms-3" style="margin-left: 30px!important">
                    <input class="form-check-input " type="radio" name="type" value="panner" >
                    <label class="form-check-label ms-5" style="margin-right: 20px;">
                        بانر
                    </label>
                </div>

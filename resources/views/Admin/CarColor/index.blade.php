...
@section('page_title') ألوان السيارات @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ألوان السيارات</h3>
                    ...
                    <div class="{{--table-responsive--}}">
                        <table id="exportexample" class="table table-striped table-responsive-lg  card-table table-vcenter text-nowrap mb-0 table-primary align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-white">موديل السيارة</th>
...
@push('admin_js')
    ...
    @include('layouts.admin.inc.ajax',['url'=>'car_colors'])
    ...
    <script>
        ...
        $(document).on('click', '#addBtn', function (e) {
            ...
            var id = "{{$id}}" ;
            setTimeout(function (){
                $('#form-load').load("{{route("car_colors.create")}}?id="+ id)
            },100)
        });
    </script>
@endpush

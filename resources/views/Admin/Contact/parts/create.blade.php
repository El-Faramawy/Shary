...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('contacts.store')}}">
    @csrf
    <input type="hidden" value="{{$contact_category_id}}" name="contact_category_id">
    <div class="row mt-0">
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            ...
            <textarea class="form-control form-control-solid" placeholder="السؤال ( بالعربية )" name="question_ar" ></textarea>
        </div>
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            <label class="d-flex align-items-center fs-6 fw-bold form-label ">
            ...
            <textarea class="form-control form-control-solid" placeholder="السؤال ( بالانجليزية )" name="question_en" ></textarea>
        </div>
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            <label class="d-flex align-items-center fs-6 fw-bold form-label ">
            ...
            <textarea class="form-control form-control-solid" placeholder="الاجابة ( بالعربية )" name="answer_ar" ></textarea>
        </div>
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            <label class="d-flex align-items-center fs-6 fw-bold form-label ">
            ...
            <textarea class="form-control form-control-solid" placeholder="الاجابة ( بالانجليزية )" name="answer_en" ></textarea>
        </div>

...
@section('page_title') انواع السيارات @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">انواع السيارات</h3>
                    ...
                    <div class="{{--table-responsive--}}">
                        <table id="exportexample" class="table table-striped table-responsive-lg  card-table table-vcenter text-nowrap mb-0 table-primary align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-white">التصنيفات</th>
...
@push('admin_js')
    ...
    <script>
        var  columns =[
            ...
            {data: 'car_categories', name: 'car_categories'},
            {data: 'action', name: 'action', orderable: false, searchable: false},
        ];
        //======================== addBtn =============================

    </script>
    @include('layouts.admin.inc.ajax',['url'=>'car_types'])
